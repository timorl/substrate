...
mod tests {
	...
	fn reject_wrong_share() {
		let key_box = TrivialKeyBox{ my_id: Some(0), n_members: 10, threshold: 3};
		let wrong_share_1 = TrivialShare{ member_id: 11, nonce: H256::default(), actual_share: 11};
		let wrong_share_2 = TrivialShare{ member_id: 8, nonce: H256::default(), actual_share: 0};
